...
postMovimento = async (data) => {
  sql =
    ...
    (data, descricao, patrimonio_tipo_movimento_id_patrimonio_tipo_movimento, patrimonio_item_id_patrimonio_item)
    VALUES
    ('${data.date.substring(0, 10)}', 
    '${data.descricao}',
     ${data.patrimonio_tipo_movimento_id_patrimonio_tipo_movimento},
...
putTipoMovimento = async (data, idTipoMovimento) => {
