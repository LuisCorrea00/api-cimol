...
CREATE TABLE `armario` (
  `id_armario` int unsigned NOT NULL AUTO_INCREMENT,
  `numero` int DEFAULT NULL,
  `local` varchar(45) DEFAULT NULL,
  `curso_id_curso` int unsigned NOT NULL,
  PRIMARY KEY (`id_armario`),
  UNIQUE KEY `id_armario_UNIQUE` (`id_armario`),
  KEY `fk_armario_curso1_idx` (`curso_id_curso`),
  CONSTRAINT `fk_armario_curso1` FOREIGN KEY (`curso_id_curso`) REFERENCES `curso` (`id_curso`)
