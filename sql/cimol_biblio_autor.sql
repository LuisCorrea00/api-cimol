...
--
-- Table structure for table `biblio_autor`
--

DROP TABLE IF EXISTS `biblio_autor`;
...
--
-- Dumping data for table `biblio_autor`
--

LOCK TABLES `biblio_autor` WRITE;
/*!40000 ALTER TABLE `biblio_autor` DISABLE KEYS */;
/*!40000 ALTER TABLE `biblio_autor` ENABLE KEYS */;
UNLOCK TABLES;
